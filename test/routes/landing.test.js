...
describe('GET / landing redesign', () => {
  ...
  test('exposes the supplied Saleté Sincère image in complete social metadata', async () => {
    ...
    assertContains(response.body, /<meta property="og:image" content="https:\/\/saletesincere\.fr\/cdn-cgi\/image\/width=1200,height=630,fit=cover,quality=92,format=jpeg\/https:\/\/saletesincere\.fr\/images\/shareimg\.jpg">/)
    ...
    assertContains(response.body, /<meta name="twitter:image" content="https:\/\/saletesincere\.fr\/cdn-cgi\/image\/width=1200,height=630,fit=cover,quality=92,format=jpeg\/https:\/\/saletesincere\.fr\/images\/shareimg\.jpg">/)
