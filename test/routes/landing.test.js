...
describe('GET / landing redesign', () => {
  ...
  test('exposes the supplied Saleté Sincère image in complete social metadata', async () => {
    ...
    assertContains(response.body, /<meta property="og:image" content="https:\/\/saletesincere\.fr\/cdn-cgi\/image\/width=1200,height=630,fit=cover,quality=85,format=png\/https:\/\/saletesincere\.fr\/images\/shareimg\.jpg">/)
    assertExcludes(response.body, /<meta property="og:image:type"/)
    assertContains(response.body, /<meta property="og:image:width" content="1200">/)
    assertContains(response.body, /<meta property="og:image:height" content="630">/)
    ...
    assertContains(response.body, /<meta name="twitter:image" content="https:\/\/saletesincere\.fr\/cdn-cgi\/image\/width=1200,height=630,fit=cover,quality=85,format=png\/https:\/\/saletesincere\.fr\/images\/shareimg\.jpg">/)
